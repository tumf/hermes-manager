...
Hermes Agents WebApp ist eine Next.js-Anwendung zur zentralen Verwaltung von Hermes Agents, die in der Mini-Umgebung betrieben werden, über eine Web-Oberfläche.
...
![Hermes Agents Speicherverwaltung](./docs/images/ss-agent_memory-1.png)
