...
![Снимок экрана Hermes Agents WebApp](./docs/images/ss-agents-1.png)

Hermes Agents WebApp — это приложение на Next.js для централизованного управления Hermes Agents, работающими в среде mini, через веб-интерфейс.
Оно объединяет создание, дублирование, удаление, управление запуском/остановкой, редактирование конфигурации, управление переменными окружения, управление навыками, операции с cron-заданиями, просмотр истории чатов и просмотр логов.
...
> **Приложение для доверенной сети** — Hermes Agents WebApp разработан для работы в доверенных сетях/интранете. Он не включает аутентификацию для публичного интернета или мультиарендный контроль доступа. При размещении за пределами доверенной сети добавьте собственный уровень аутентификации и контроля доступа.
...
![Экран управления памятью Hermes Agents](./docs/images/ss-agent_memory-1.png)
