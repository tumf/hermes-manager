...
- [x] Validate the OpenSpec proposal after authoring the delta (verification: manual - run `python3 ~/.agents/skills/cflx-proposal/scripts/cflx.py validate add-semver-bump-scripts --strict`).
