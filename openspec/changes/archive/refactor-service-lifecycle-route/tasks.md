...
- [x] strict validation を通す（verification: automated - `python3 /Users/tumf/.hermes/skills/cflx-proposal/scripts/cflx.py validate refactor-service-lifecycle-route --strict`）
