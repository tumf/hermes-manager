...
- /runtime/agents/{agentId}/
  - SOUL.md, config.yaml, .env, logs/, memories/MEMORY.md, memories/USER.md
...
- /api/files: GET/PUT（SOUL.md/memories/MEMORY.md/memories/USER.md/config.yaml）
...
- Agent 詳細: ヘッダーに name/description/tags の表示のみ、タブ（Metadata/Memory/Config/Env/Skills/Cron/Chat/Logs）
  ...
  - Memory は `SOUL.md` / `memories/MEMORY.md` / `memories/USER.md` を切替ボタンで選択し、常に1ファイルのみ編集表示（デフォルト `SOUL.md`）
